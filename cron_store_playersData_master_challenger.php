...
<?php
    ...
    if(isset($_GET['enable'])) {
        ...
        $master_elo = file_get_contents("https://euw.api.pvp.net/api/lol/euw/v2.5/league/master?type=RANKED_SOLO_5x5&api_key=".$apiKey);
        ...
        // Get all of the player ids in master league
        $challenger_elo = file_get_contents("https://euw.api.pvp.net/api/lol/euw/v2.5/league/challenger?type=RANKED_SOLO_5x5&api_key=".$apiKey);
        ...
        $sql = "SELECT sum_id FROM challengerandmaster_data";
        ...
        foreach ($playersDelete as $playerDelete) {
            $sql = "DELETE FROM challengerandmaster_data WHERE sum_id=".$playerDelete;
            if($conn->query($sql)) {
