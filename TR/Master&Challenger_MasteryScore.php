...
<div class="ContentWrap">
    ...
    $sql = "SELECT summoner_info, tier_info FROM challengerandmaster_data_TR";
    ...
    if($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            array_push($players, array(
                ...
                'masteryScore' => getMasteryPoints($conn, $summonerData->name, "challengerandmaster_data_TR")
            ));
            array_push($playersOrder, getMasteryPoints($conn, $summonerData->name, "challengerandmaster_data_TR"));
        }
