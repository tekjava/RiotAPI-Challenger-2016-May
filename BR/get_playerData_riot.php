...
class PlayerData {
    ...
    public function getSummonerTier() {
        ...
        return json_decode(file_get_contents('https://br.api.pvp.net/api/lol/br/v2.5/league/by-summoner/' . $sumonerId . '/entry?api_key=' . $this->apiKey))->$sumonerId;
    }

    public function getRankedChampsInfo() {
        sleep(2);
        return json_decode(file_get_contents('https://br.api.pvp.net/api/lol/br/v1.3/stats/by-summoner/' . $this->summonerData->id . '/ranked?season=SEASON2016&api_key=' . $this->apiKey));
    }
}
