...
<meta property="og:url" content="Master&Challenger_ChampionPoints.php">
...
<div id="dataProvider" data-static-path="# site main pg" data-current-realm="EUNE" data-current-name=""></div>
<div id="wrapOuter">

<nav>
<div class="HeaderTools"><dl><dd class="Region"><a href="#" onclick="showIFrame('#');return false;"><i class='__spSite __spSite-106'></i><?php echo $lang['LANG_TOP']; ?></a></dd></dl></div>
...
<div class="ContentWrap">
			...
			<thead class="Header"><tr class="Row"><th class="Rank HeaderCell"></th><th class="Summoner HeaderCell" colspan="2"><?php echo $lang['MC_PAGE_SUMMONERS']; ?></th><th class="TierRank HeaderCell"><?php echo $lang['MC_PAGE_Tier']; ?></th>
			<th class="LP HeaderCell"><?php echo $lang['MC_PAGE_LP']; ?></th><th class="game HeaderCell"><?php echo $lang['MC_PAGE_LastGame']; ?></th><th class="RatioGraph HeaderCell"><?php echo $lang['MC_PAGE_TOTALCHAMPPOINTS']; ?></th></tr></thead>
			<tbody class="Body">
    ...
    $sql = "SELECT sum_name, summoner_info, tier_info FROM challengerandmaster_data_EUNE";
    ...
    if($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            array_push($players,
                array('name' => $summonerData->name, 'profileIconId' => $summonerData->profileIconId, 'tier' => $tierData->tier, 'division' => $tierEntry->division, 'lp' => $tierEntry->leaguePoints, 'time' => $epoch->format('d-m-y H:i:s'), 'championPoints' => getChampPoints($conn, $row['sum_name'], "challengerandmaster_data_EUNE"))
            );
            array_push($playersOrder, getChampPoints($conn, $row['sum_name'], "challengerandmaster_data_EUNE"));
        }

        rsort($playersOrder);

        usort($players, function ($a, $b) use ($playersOrder) {
            $pos_a = array_search($a['championPoints'], $playersOrder);
            $pos_b = array_search($b['championPoints'], $playersOrder);
            return $pos_a - $pos_b;
        });

        $championPointsNumbers = array_values(array_unique($playersOrder));
        $playersByCP = array();

        for ($i = 0; $i < count($championPointsNumbers); $i++) {
            $sameCP = array();

            for ($j=0; $j < count($players); $j++) {
                $sameCPPlayer = array();
                if($players[$j]['championPoints'] == $championPointsNumbers[$i]) {
                    $sameCPPlayer['lp'] = $players[$j]['lp'];
                    $sameCPPlayer['player'] = $players[$j];
                    array_push($sameCP, $sameCPPlayer);
                }
            }
            rsort($sameCP);
            foreach ($sameCP as $sameCPPlayer) {
                array_push($playersByCP, $sameCPPlayer['player']);
            }
        ...
        foreach ($playersByCP as $playerByCP) {
            // print_r($playerByMS);
            // echo "<br>";
            $index++;
            ...
            <a href="profile.php?userName='.$playerByCP['name'].'" class="Link" target="_blank">
            <img src="http://ddragon.leagueoflegends.com/cdn/6.9.1/img/profileicon/'.$playerByCP['profileIconId'].'.png" class="Image">
            </a>
            </td>

            <td class="SummonerName Cell">
            <a href="profile.php?userName='.$playerByCP['name'].'" class="Link" target="_blank">'.$playerByCP['name'].'</a>
            </td>

            <td class="TierRank Cell">'.$playerByCP['tier'].' '.$playerByCP['division'].'</td>

            <td class="LP Cell">'.$playerByCP['lp'].' LP</td>

            <td class="LP Cell">'.$playerByCP['time'].'</td>

            <td class="RatioGraph Cell">
            <div class="WinRatioGraph">
            <div class="Graph">

            <div class="Text Left">'.number_format((int)$playerByCP['championPoints']).' '.$lang['MC_PAGE_CHAMPIONPOINTS'].'</div>
                                                            ...
                                                            <table class="Table">
			                                                    <tbody class="Body">
						                                            ...
						                                            <!-- ENGLISH LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=en" class="Link">
																	...
																	<!-- FRENCH LANGUAGE OPENS -->
						                                                <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=fr" class="Link">
																	...
																	<!-- GERMAN LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=de" class="Link">
						                                            ...
						                                            <!-- POLAND LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=pl" class="Link">
																	...
																	<!-- KOREAN LANGUAGE OPENS -->
						                                                <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=kr" class="Link">
																	...
																	<!-- SWEDISH LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=se" class="Link">
						                                            ...
						                                            <!-- JAPAN LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=ja" class="Link">
						                                            ...
						                                            <!-- SPAIN LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=es" class="Link">
																	...
																	<!-- DANISH LANGUAGE OPENS -->
						                                                <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=da" class="Link">
						                                            ...
						                                            <!-- ROMANIAN LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=rom" class="Link">
						                                            ...
						                                            <!-- NORWEGIAN LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=no" class="Link">
						                                            ...
						                                            <!-- RUSSIAN LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=ru" class="Link">
																	...
																	<!-- HUNGARIAN LANGUAGE OPENS -->
						                                                <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=hu" class="Link">
						                                            ...
						                                            <!-- FINNISH LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=fi" class="Link">
						                                            ...
						                                            <!-- TURKISH LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=tr" class="Link">
						                                            ...
						                                            <!-- SLOVENIAN LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=sl" class="Link">
																	...
																	<!-- PORTUGESE LANGUAGE OPENS -->
						                                                <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=pt" class="Link">
						                                            ...
						                                            <!-- CHINESE LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=zh" class="Link">
						                                            ...
						                                            <!-- SERBIAN LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=sr" class="Link">
						                                            ...
						                                            <!-- ITALIAN LANGUAGE OPENS -->
																	    <td class="Cell ">
							                                                <a href="Master&Challenger_ChampionPoints.php?lang=it" class="Link">
