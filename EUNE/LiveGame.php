...
<head>
<title><?php echo $lang['HOME_HOMEPAGE_TITLE_lIVEGAMES']; ?></title>
<base >
<meta charset="utf-8">
...
<div class="Contents center_div">
							...
							<div class="Logo">
							<img src="img/teemo_lol.png" title="LoLMastery Logo" class="Image">
							</div>

							<form class="SearchInput" action="livegamedata.php">
							<input type="text" name="userName" class="Summoner" placeholder="<?php echo $lang['SUMMONER_SEARCHLIVE_PLACEHOLDER']; ?>">
